              ...
              <b> ปีที่ตีพิมพ์ </b>
               ...
               <!---list-group-item---->
                  ...
                  <?php  
                        ...
                        //  echo '<hr>';
                        // $arr_year[$row['year']] = $row['year'];
                        }
                        echo "</div>";
                        // echo Html::dropDownList( $arr_year, '', $arr_year,  ['options'=>['style' => '']]  );
                  ?>
                   </li>
              </ul>
              <b> ชื่อผู้แต่ง </b>
               <ul class="list-group">
                  ...
                  <?php  
                        ...
                        //  echo '<hr>';
                            //$arr_fau[$row_fau['content']] = trim($row_fau['content']);
                        }
                        // echo "</details>";
                        echo'</div>';

                        // echo Html::dropDownList( $arr_fau, '', $arr_fau,  ['style' => 'width:80%;']  );
                  ?>
                   </li>
              </ul>
